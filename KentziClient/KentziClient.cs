    ...
    class KentziTest
    {
        static int Main(string[] args)
        {
			...
			List<KentziLineItem> lineItems = new List<KentziLineItem> {
				new KentziLineItem("0000999", "2000","Pepsi", "Pepsi 500 ml", 20.0, 4.0, 6)
			};

			KentziReceipt o = new KentziReceipt("8116916048", kentzi.StoreId, "0000999", 200.0, 20.0, "localhost", DateTime.Now, lineItems);
